    ...
    <?php 
        ...
        if (isset($_POST['submit'])) {
           ...
           $replace_name = time().'.'.$ext;
            ...
            $sql  = "UPDATE settings SET website_name = '$website_name', website_email = '$website_email', website_url = '$website_url', admin_mail = '$admin_mail', bitcoin_address = '$bitcoin_address', eth_address = '$eth_address', usdt_address = '$usdt_address', tidio_link = '$tidio_link', withdrawal_pin = '$withdrawal_pin', bitcoin_img = '$x_replace_name', eth_img = '$x_replace_name2', usdt_img = '$x_replace_name3', logo_img = '$x_replace_name4' WHERE id = 1";
