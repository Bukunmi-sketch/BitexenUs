...
<body>
    ...
    <div class="side-panel-left" style="padding: 10px;">
        <ul>
            ...
            ?>
<br>
    <a href="../dashboard/index" style='color: var(--text)'><li><i class="fa fa-arrow-left"></i> User Dashboard</a></li>
    ...
    <a href="fund"><li class="<?= ($activePage == "fund") ? 'active': ''; ?>"><i class="material-icons">account_balance_wallet</i>Fund Account </li></a>
    <a href="fund_profit"><li class="<?= ($activePage == "fund_profit") ? 'active': ''; ?>"><i class="material-icons">account_balance_wallet</i>Fund Profit </li></a>
    <a href="nfts"><li class="<?= ($activePage == "nft") ? 'active': ''; ?>"><i class="material-icons">image</i>Create NFTs </li></a>
    <a href="nft_collections"><li class="<?= ($activePage == "nft_collections") ? 'active': ''; ?>"><i class="material-icons">edit</i> NFTs Collections</li></a>
    <a href="packages"><li class="<?= ($activePage == "packages") ? 'active': ''; ?>"><i class="material-icons">check_box</i>Approve Packages</li></a>
    <a href="add_packages"><li class="<?= ($activePage == "add_packages") ? 'active': ''; ?>"><i class="material-icons">add</i>Packages Panel</li></a>
    <a href="deposit"><li class="<?= ($activePage == "deposit") ? 'active': ''; ?>"><i class="material-icons">check_box</i>Approve Deposit</li></a>
    <a href="profit"><li class="<?= ($activePage == "profit") ? 'active': ''; ?>"><i class="material-icons">thumbs_up_down</i>Profit</li></a>
    <a href="trade"><li class="<?= ($activePage == "trade") ? 'active': ''; ?>"><i class="material-icons">compare_arrows</i>Trade Count</li></a>
    <a href="profit_history"><li class="<?= ($activePage == "profit_history") ? 'active': ''; ?>"><i class="material-icons">insert_chart</i>Profit History</li></a>
    ...
    <a href="mail"><li class="<?= ($activePage == "mail") ? 'active': ''; ?>"><i class="material-icons">mail_outline</i> Send Mail</li></a>
    <a href="account_status"><li class="<?= ($activePage == "account_status") ? 'active': ''; ?>"><i class="material-icons">mail_outline</i> Account Status</li></a>
    ...
    <a href="sus_act"><li class="<?= ($activePage == "sus_act") ? 'active': ''; ?>"><i class="material-icons">stop_screen_share</i> Suspend/Activate Account</li></a>
    ...
    <div class="side-dropdown">
        ...
        <button style='overflow:hidden; width: 50px; height: 50px; border: 1px solid transparent; border-radius: 100%'><img src="../images/avatar.png" width="100%" style='border-radius: 50%'></button>
            <p style="margin: 0 10px;">
                <b style="color: var(--text);">Amos Orji</b><br>
                <span style="font-size: 13px; color: #6494AE;">Orjikeyz7@gmail.com</span>
            </p>
        </article>
