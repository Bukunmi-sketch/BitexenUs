            ...
            <div class="nk-block nk-block-middle nk-auth-body wide-xs">
                ...
                <div class="card card-bordered">
                    <div class="card-inner card-inner-lg">
                        <div class="nk-block-head">
                            <div class="nk-block-head-content">
                                <h4 class="nk-block-title"><!--Verify Your Email Address -->Resend Otp</h4>
                  ...
                  <!--      <p>A verification link has been sent to:</p>
                        ...
                        <p><!-- Please click the button in the message to confirm your email address or type in your Email to receive a new activation code. -->
