...
<body class="light">
  ...
  <div class="Optimal-breadcrumb-section">
    <div class="container">
      <div class="breadcrumbs">
        <h1 class="wow fadeInUpX" data-wow-delay="0s">About Us</h1>
  ...
  <div class="Optimal-about-section">
    <div class="container">
      <div class="row">
        <div class="col-xl-7 col-lg-6">
          <div class="Optimal-about-thumb">
            <img class="wow fadeInLeft" data-wow-delay=".10s" src="assets/images/all-img/about/about-thumb1.png" alt="">
            <div class="Optimal-about-thumb2">
              <img class="wow fadeInUpX" data-wow-delay=".30s" src="assets/images/all-img/about/about-thumb2.png" alt="">
            </div>
          </div>
        </div>
        <div class="col-xl-5 col-lg-6 col-md-11 d-flex align-items-center">
          <div class="Optimal-default-content">
            <h2>Who we Are!</h2>
            <p><?php echo $website_name?> is an award-winning bitcoin exchange & Investment broker, providing trading services and facilities to both retail and institutional clients. <?php echo $website_name?> has positioned itself as the forex broker of choice for traders worldwide.</p>
            <p>We have a history that dates back to 2009 when bitcoin was created, We laid the groundwork for the world’s first bitcoin trading service. Since then, we have grown from strength to strength, gaining the trust of traders around the world.</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="Optimal-iconbox-wrap4 wow fadeInUpX" data-wow-delay=".20s">
            ...
            <div class="Optimal-iconbox-data4">
              ...
              <p>Easy trading, join millions gaining high profitability ratios daily from crypto trading & investing</p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
          <div class="Optimal-iconbox-wrap4 wow fadeInUpX" data-wow-delay=".30s">
            <div class="Optimal-iconbox-icon4">
              <img src="assets/images/all-img/about/icon3.png" alt="">
            </div>
            <div class="Optimal-iconbox-data4">
              <h4>Creative team</h4>
              <p>Get 24/7 on demand support from our friendly & Experienced customer success representatives.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="section Optimal-section-padding2">
    <div class="container">
      <div class="Optimal-section-title2">
        <div class="row">
          <div class="col-lg-6">
            <h2>We Are on a mission to helping you invest smartly</h2>
          </div>
          <div class="col-lg-5 offset-lg-1 d-flex align-items-center">
            <p>Our goal is to provide our customers with the best posible trading trading tools or product as well as provide you with the needed support to win. It is the core mission of our company.</p>
          </div>
        </div>
      </div>
      <div class="Optimal-video-thumb Optimal-video-thumb3 wow fadeInUpX" data-wow-delay=".10s">
        <img src="assets/images/all-img/about/video-thumb-1.png" alt="">
  ...
  <div class="Optimal-counter-section bg-gray-800">
    <div id="Optimal-counter"></div>
    <div class="container">
      <div class="row">
        <div class="col-xl-7">
          <div class="Optimal-counter-wrap">
            <div class="Optimal-counter-data wow fadeInUpX" data-wow-delay=".10s">
              <h2><span data-percentage="83" class="Optimal-counter"></span><strong>M+</strong></h2>
              <p>Total tranaction Volume</p>
            </div>
            <div class="Optimal-counter-data wow fadeInUpX" data-wow-delay=".20s">
              <h2><span data-percentage="6" class="Optimal-counter"></span><strong>M</strong></h2>
              <p>Satisfied clients around the world</p>
            </div>
            <div class="Optimal-counter-data wow fadeInUpX" data-wow-delay=".30s">
              <h2><span data-percentage="4.9" class="Optimal-counter"></span><strong>%</strong></h2>
              <p>Our company's success rate</p>
            </div>
          </div>
        </div>
        <div class="col-xl-5 d-flex align-items-center">
          <div class="Optimal-default-content content-white">
            <h2>Take a look at what we've accomplished</h2>
            <div class="Optimal-counter-rating">
              <ul>
                <li><img src="assets/images/all-img/about/trustpilot.png" alt=""></li>
  ...
  <div class="section Optimal-section-padding3">
    <div class="container">
      ...
      <div class="row">
                      ...
                      <li>
                        <a href="">
                          <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2.61761 13.7535V7.8033H0.615234V5.48437H2.61761V3.77424C2.61761 1.78964 3.82974 0.708984 5.60014 0.708984C6.44818 0.708984 7.17702 0.772123 7.38943 0.800344V2.87437L6.16156 2.87492C5.19872 2.87492 5.01229 3.33245 5.01229 4.00385V5.48437H7.30858L7.00959 7.8033H5.01228V13.7535H2.61761Z" fill="#13111A" />
                          </svg>
                        </a>
                      </li>
                      <li>
        ...
        <div class="col-xxl-3 col-lg-4 col-md-6">
          <div class="Optimal-team-wrap wow fadeInUpX" data-wow-delay=".20s">
            <div class="Optimal-team-thumb">
              <img src="assets/images/all-img/about/team/2.png" alt="">
              <div class="Optimal-team-data">
        ...
        <div class="col-xxl-3 col-lg-4 col-md-6">
          <div class="Optimal-team-wrap wow fadeInUpX" data-wow-delay=".30s">
            <div class="Optimal-team-thumb">
              <img src="assets/images/all-img/about/team/3.png" alt="">
              <div class="Optimal-team-data">
                <h5>Esther Howard</h5>
                <div class="Optimal-team-data-wrap">
                  <p>VP Planning & Strategy</p>
                  <div class="Optimal-social-icon2">
                    <!-- <ul>
                      <li>
                        <a href="">
        ...
        <div class="col-xxl-3 col-lg-4 col-md-6 offset-xxl-0 offset-lg-4">
          <div class="Optimal-team-wrap wow fadeInUpX" data-wow-delay=".40s">
            <div class="Optimal-team-thumb">
              <img src="assets/images/all-img/about/team/4.png" alt="">
              <div class="Optimal-team-data">
  ...
  <div class="Optimal-client-section">
    <div class="container">
      <div class="Optimal-client-title">
        <h5>Trusted by 1600+ of the world's most popular companies</h5>
      </div>
      <div class="Optimal-client-slider2">
        <div class="Optimal-brand-logo">
          <img src="assets/images/all-img/about/client1.png" alt="">
        </div>
        <div class="Optimal-brand-logo">
          <img src="assets/images/all-img/about/client2.png" alt="">
        </div>
        <div class="Optimal-brand-logo">
          <img src="assets/images/all-img/about/client3.png" alt="">
        </div>
        <div class="Optimal-brand-logo">
          <img src="assets/images/all-img/about/client4.png" alt="">
        </div>
        <div class="Optimal-brand-logo">
          <img src="assets/images/all-img/about/client5.png" alt="">
        </div>
        <div class="Optimal-brand-logo">
          <img src="assets/images/all-img/about/client6.png" alt="">
        </div>
        <div class="Optimal-brand-logo">
          <img src="assets/images/all-img/about/client7.png" alt="">
        </div>
        <div class="Optimal-brand-logo">
          <img src="assets/images/all-img/about/client8.png" alt="">
        </div>
        <div class="Optimal-brand-logo">
          <img src="assets/images/all-img/about/client9.png" alt="">
        </div>
        <div class="Optimal-brand-logo">
          <img src="assets/images/all-img/about/client10.png" alt="">
        </div>
        <div class="Optimal-brand-logo">
          <img src="assets/images/all-img/about/client1.png" alt="">
        </div>
