...
<body class="light">
  ...
  <div class="Optimal-breadcrumb-section">
    <div class="container">
      <div class="breadcrumbs">
        <h1 class="wow fadeInUpX" data-wow-delay="0s">Our Service</h1>
  ...
  <div class="Optimal-innovative-services-section">
    <div class="container">
      <div class="row">
        <div class="col-xxl-6 col-xl-6 col-lg-6 offset-xxl-1 order-lg-2">
          <div class="Optimal-innovative-services-thumb wow fadeInUpX">
            <img src="assets/images/all-img/service/thumb.png" alt="">
          </div>
        </div>
        <div class="col-xxl-5 col-xl-6 col-lg-6 col-md-10 d-flex align-items-center">
          <div class="Optimal-default-content">
            <h2>Trade on Optimal Fx</h2>
            <p>Learn about the markets that you can trade online with Optimal Trade Fx, including forex, synthetic indices, stocks & indices, cryptocurrencies, basket indices, and commodities.</p>
            <p>CFD trading allows you to trade on the price movement of an asset without buying or owning the underlying asset.Options trading allows for fixed payouts from correctly predicting market movements, without needing to buy an underlying asset. Multipliers allow you to trade on leverage while limiting downside risk to your investment. You can maximise your potential profit by several multiples of any market movement without risking more than your initial investment.</p>
          </div>
        </div>
      </div>
  ...
  <div class="section Optimal-section-padding3">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="Optimal-iconbox-wrap Optimal-iconbox-wrap5 wow fadeInUpX" data-wow-delay="0s">
        ...
        <div class="col-lg-6">
          <div class="Optimal-iconbox-wrap Optimal-iconbox-wrap5 wow fadeInUpX" data-wow-delay=".10s">
            <div class="Optimal-iconbox-icon">
        ...
        <div class="col-lg-6">
          <div class="Optimal-iconbox-wrap Optimal-iconbox-wrap5 wow fadeInUpX" data-wow-delay=".20s">
            <div class="Optimal-iconbox-icon">
        ...
        <div class="col-lg-6">
          <div class="Optimal-iconbox-wrap Optimal-iconbox-wrap5 wow fadeInUpX" data-wow-delay=".30s">
            <div class="Optimal-iconbox-icon">
        ...
        <div class="col-lg-6">
          <div class="Optimal-iconbox-wrap Optimal-iconbox-wrap5 wow fadeInUpX" data-wow-delay=".40s">
            <div class="Optimal-iconbox-icon">
              <img src="assets/images/all-img/icon5.png" alt="">
            </div>
            <div class="Optimal-iconbox-data">
              <h4>Watch and analyze charts</h4>
              <p>Stay Informed with a simple yet intutive and fully customisable dashboard.</p>
            </div>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="Optimal-iconbox-wrap Optimal-iconbox-wrap5 wow fadeInUpX" data-wow-delay=".50s">
            <div class="Optimal-iconbox-icon">
              <img src="assets/images/all-img/icon6.png" alt="">
            </div>
            <div class="Optimal-iconbox-data">
              <h4>Invest in real time</h4>
              <p>Invest in cryptocurrencies, forex, stocks and even NFT's in real time with our highly avanced platform</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <!-- <div class="section bg-warning-300 Optimal-section-padding2">
    <div class="container">
      ...
      <div class="pricing-btn d-flex align-items-center justify-content-center flex-wrap ">
        <label class="mb-3 mb-lg-0">Billed Annually</label>
        ...
        <label class="mb-3 mb-lg-0">Billed Monthly</label>
      </div>
      <div class="row" id="table-price-value" data-pricing-dynamic data-value-active="monthly">
        <div class="col-lg-4 col-md-6">
          <div class="Optimal-pricing-wrap wow fadeInUpX" data-wow-delay=".10s">
            <div class="Optimal-pricing-header">
              <h5>Basic</h5>
              <p>Suitable all</p>
            </div>
            <div class="Optimal-pricing-price">
              <span class="Optimal-pricing-currency">$</span>
              <div class="Optimal-price dynamic-value" data-active="1000" data-monthly="1000" data-yearly="1000"></div>
              <p class="bottom_text dynamic-value" data-active="/m" data-monthly="/m" data-yearly="/y"></p>
            </div>
            <a class="Optimal-pricing-btn" href="">Choose the plan</a>
            <div class="Optimal-pricing-body">
              <ul>
                <li><img src="assets/images/svg/check3.svg" alt="">Web trading free only mobile apps</li>
                <li><img src="assets/images/svg/check3.svg" alt="">Regulatory transaction fee available</li>
                <li><img src="assets/images/svg/check3.svg" alt="">Securities and exchange (Buy only)</li>
              </ul>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="Optimal-pricing-wrap wow fadeInUpX active" data-wow-delay=".10s">
            <div class="Optimal-pricing-header">
              <h5>Standard</h5>
            ...
            <div class="Optimal-pricing-price">
              <span class="Optimal-pricing-currency">$</span>
              <div class="Optimal-price dynamic-value" data-active="89" data-monthly="89" data-yearly="199"></div>
              <p class="bottom_text dynamic-value" data-active="/m" data-monthly="/m" data-yearly="/y"></p>
            </div>
            <a class="Optimal-pricing-btn active" href="">Choose the plan</a>
            <div class="Optimal-pricing-body">
              <ul>
                <li><img src="assets/images/svg/check4.svg" alt="">Web trading free mobile and desktop</li>
                <li><img src="assets/images/svg/check4.svg" alt="">Regulatory transaction fee available</li>
                <li><img src="assets/images/svg/check4.svg" alt="">Financial industry regulator (Buy only)</li>
              </ul>
            </div>
            <div class="Optimal-pricing-label">
              Popular
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="Optimal-pricing-wrap wow fadeInUpX" data-wow-delay=".20s">
            <div class="Optimal-pricing-header">
              <h5>Premium</h5>
              <p>Suitable for small companies and personal use</p>
            </div>
            <div class="Optimal-pricing-price">
              <span class="Optimal-pricing-currency">$</span>
              <div class="Optimal-price dynamic-value" data-active="199" data-monthly="199" data-yearly="299"></div>
              <p class="bottom_text dynamic-value" data-active="/m" data-monthly="/m" data-yearly="/y"></p>
            </div>
            <a class="Optimal-pricing-btn" href="">Choose the plan</a>
            <div class="Optimal-pricing-body">
              <ul>
                <li><img src="assets/images/svg/check3.svg" alt="">Web trading free only mobile apps</li>
                <li><img src="assets/images/svg/check3.svg" alt="">Regulatory transaction fee available</li>
                <li><img src="assets/images/svg/check3.svg" alt="">Options clearing corp (Buys & Sells)</li>
              </ul>
            </div>
        ...
        <div class="col-lg-5 offset-lg-2">
          <div class="Optimal-accordion-wrap">
            <div class="Optimal-accordion-item">
              ...
              <p>Optimal Trade provides a variety of advanced tools for both trading and cloud cryptocurrency mining thereby guaranteeing maximum profitability for all your investments.</p>
            </div>
            <div class="Optimal-accordion-item">
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="Optimal-textarea">
            ...
            <p class="Optimal-copywright">&copy; Copyright 2022, All Rights Reserved by Optimal Trade Fx</p>
          </div>
        </div>
        ...
        <div class="col-lg-2 col-md-4 col-sm-4">
          <div class="Optimal-footer-menu">
            <span>Contact</span>
            <ul>
              <!-- <li><a href="tel:123">+1 OPTIMAL TRADE</a></li> -->
