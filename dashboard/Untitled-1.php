...
<style>
    ...
    #loader {
        ...
        <div id="popup">
        <div id="loader"><img src="../images/loader.svg" width="70px" style=' z-index: 9999999'></div>
        <div id="popup-item" style='background: #061423; padding: 5px;'>
        <span style='background: #fa4b4b; padding: 3px 8px; border-radius: 3px; float: right'>x</span><br><br>
        <div id="bitcoin">
