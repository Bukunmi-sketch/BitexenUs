...
<script>
    ...
    var inpuut = document.querySelector('.inpuut');
        ...
        if (input_amount.value != "" || input_amount.value != 0) {
            if (select_input.value != "") {
                ...
                if (select_input.value == "BTC") {
                    ...
                    inpuut.value = "<?php echo $bitcoin_address ?>";
                    qrcode.src = '../images/qrcode_img/<?php echo $bitcoin_img?>';
                  //  myInput.value = "bc1qk3rt6w2nlkymdyyfft6my2yzsepzgp9k5hqxfs"
                    ...
                    qrcode.src = '../images/qrcode_img/<?php echo $eth_img?>'
                    ...
                    qrcode.src = '../images/qrcode_img/<?php echo $usdt_img?>'
