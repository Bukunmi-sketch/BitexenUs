...
<head>
    ...
    <link rel="stylesheet" href="../public/assets/css/appsf488.css?ver=1.1.0">
...
<body class="nk-body npc-cryptlite pg-auth is-dark">
    ...
    <p id="error" style='display: none'><?php echo $role; ?></p>
...
<script>
    var error = document.getElementById('error');
      ...
      if (error.textContent == "default") {
        swal("ERROR!", "Oops! an error occured while requestion for PIN", "warning");
         setTimeout(() => {
