            ...
            <div class="container-grid">
                <article>
                    <span>
                        ...
                        <span style='font-size: 18px;'> <?php echo ($role == 'default') ? $round_priceofdollar :'00'; ?> USD </span><br>
                        <span style='font-size: 11px'><?php echo $bitcoin_price; ?> BTC </span><br>
                    </span>
                ...
                <article>
                    <span>
                        ...
                        <span style='font-size: 18px;'><span><?php echo ($role == 'default') ? $round_priceofdollar :'00'; ?> USD</span></span><br>
                        <span style='font-size: 11px'><?php echo $bitcoin_price; ?> BTC </span><br>
                    </span>

                    <span>
                        <i class="material-icons">compare_arrows</i><br>
                        <span >Bonus <br> <?php echo ($role == 'default') ? $round_priceofdollar :'00'; ?> USD</span>
                    </span>
                </article>

                <article>
                <div style='display: unset'>
                <b style='font-size: 13px'>Funding</b><br>
                ...
                <article>
                    <span>
                        <b style='font-size: 13px'> Futures</b><br>
