      ...
      <center> <img src="../images/<?php echo $image?>" width="100px" height='100px' style='border-radius: 5px'></center>
       ...
       <div class="form" style='background: var(--primary-two); padding: 20px'>
            <div style='display: flex; align-items: center; color: var(--text)'>
                <span style='margin-right: 20px; border: 2px solid var(--text); padding: 5px; border-radius: 50%'>03</span>
                <span><h3>Document Upload</h3>
                     <p style='font-size: 13px'>To verify your identity, please upload any of your document.</p>
                </span>
            </div><br><hr><br>
            <p style='font-size: 13px; color: var(--text); padding: 10px'><i class="fa fa-question-circle-o" style='font-size: 10px'></i> In order to complete, please upload any of the following personal document.</p><br>

            <div class="input-grid">
                <article>
                    <div class="tab active-tab">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width='30px' viewBox="0 0 71.9904 75.9285">
                        ...
                        <span style='margin-left: 10px; font-size: 13px; color: var(--text)'>Passport</span>
                    </div>
                </article>
                ...
                <div class="tab">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width='30px' viewBox="0 0 76 63">
                        ...
                        <span style='margin-left: 10px; font-size: 13px; color: var(--text)'>National ID</span>
                    </div>
            ...
            <div class="input-grid">
                ...
                <div class="tab">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width='30px' viewBox="0 0 76 76">
                        ...
                        <span style='margin-left: 10px; font-size: 13px; color: var(--text)'>Driving License</span>
                    </div>
        ...
        <div style='font-size: 13px; color: var(--text); line-height: 25px'>
                        ...
                        <i class="fa fa-check-square"></i> Receive payments from CapitalXCH <br>
                   </div><br>
            ...
            <?php 
              // $type = htmlspecialchars(trim($_POST['type']));
                    ...
                    //         $sql = "INSERT INTO kyc (image, image2) VALUES ('$image_name', '$image_name')";
                ...
                if (isset($_POST['upload'])) {
                   ...
                   $replace_name = time().'.'.$ext;
                    ...
                    $sql = "UPDATE kyc SET image = '$x_replace_name', image2 = '$x_replace_name2', type = '$type' WHERE kyc_user_id = '$user_id'";
                    if ($connection->query($sql)===TRUE) {
                        echo "<script>
                                alert('Your Details have been uploaded successfully. Thank you.')
        ...
        <form action="" method="post" enctype="multipart/form-data">
                ...
                <div style='display: grid; grid-template-columns: 1fr 1fr'>
                    ...
                    <h4>Back</h4>
                        <label for="" id='label-file'>
                            <i class="fa fa-image"></i>
                        <input type="file" name="img2" id='file'  required>
                        </label>
                    </article>
...
<script>
    var tab = document.querySelectorAll('.tab')[0];
