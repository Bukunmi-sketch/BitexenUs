<?php 
   ...
   if ($amount >= $balance) {
      ...
      if ($stmt->execute()){
          // send mail
          $to = "$email";
          $subject = "Signal Plan Purchase Request {$date}";
          $message = "
          ...
          <p>Your pending signal plan purchase of $d_amount USDT ({$package}) <br> is been processed. You will be notified when your purchased is <b>Active</b></p>
         ...
         echo $error = "success";
                          // send mail
                          $to = "$admin_mail";
                          $subject = "Hello Admin, somebody made a Signal Plan Request {$date}";
                          $message = "
                          <div style='background: #E4E9F0'>
                          <center><img src='$website_url/images/dashboard-logo.png' width='100px;'></center>
                          <div style='font-family: sans-serif; padding: 10px; margin: 5px; background: white; margin: 5px 5%; border-radius: 10px;'>
